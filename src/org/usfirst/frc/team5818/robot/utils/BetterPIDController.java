 ...
 */
public class BetterPIDController implements PIDInterface, LiveWindowSendable {
    ...
    private class PIDTask extends TimerTask {
        ...
        public PIDTask(BetterPIDController controller) {
            if (controller == null) {
    ...
    /**
     * Set the setpoint for the PIDController Clears the queue for
     * GetAvgError(). $
     * 
     * @param setpoint
